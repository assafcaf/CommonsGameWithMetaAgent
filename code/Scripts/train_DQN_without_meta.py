...
from code.PolicyGradientTrainerWithMetaAgent.trainer import TrainerDQNNoMetaAgent as Trainer
import os
import warnings
...
if __name__ == '__main__':
    ...
    folders_name = f"{date.today().strftime('%Y-%m-%d')}_noMeta_{n_players}_DQN_512_512_seqLen_2"
